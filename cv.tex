...
\newcommand{\myTitle}{Full-stack Software Developer}
\newcommand{\targetCompanyName}{ Bionic System Solutions } % 填写求职的公司名
...
\textcolor{accentLine}{\rule{#1 * \real{#2} / 100}{0.7ex}}%
...
% Heading %
%---------%
\begin{minipage}{1.95\textwidth} %% 1.95 for hide the photo
% \begin{minipage}{\textwidth} %% if I should use photo, that should back to 1.0
	\colorbox{accentText}{
		% \input{photo.tex}
		\input{title.tex}
	}
...
% \vspace{1.5em}% \input{passions.tex}
...
% \input{coverLetter/Autorola.tex}
